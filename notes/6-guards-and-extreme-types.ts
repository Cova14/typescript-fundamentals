...
myAny.foo.bar.baz;
// myAny.a.b.c.s.d.s.s.e.d.f.e.d.g.e
myUnknown.foo;
...
const list = ['a', 'b', 'c', undefined, 'd'] // (string | undefined)[]
const filtered = list.filter(isDefined) // string[]
...
if (typeof y === "string") {
  ...
  // Exaustive switch / case
  // This creates a high amount of safety
